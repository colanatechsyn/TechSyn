      ...
      >
        ...
        <div className="flex gap-2 justify-center ">
          <div className="p-[2px] w-1/2 rounded-lg  bg-gradient-to-r from-purple-500 to-indigo-600">
            <button className="w-full px-4 py-2 text-purple-600 bg-[#fdfdfe] rounded-[6px] text-sm hover:bg-purple-100">
              <span className="bg-gradient-to-r from-purple-500 to-indigo-600 bg-clip-text text-transparent font-semibold">
                Ver mais
              </span>
            </button>
          </div>
          {/* Botão "Sobre" com fundo gradiente */}
          <button className="px-4 py-2 w-[100px] bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg text-sm hover:bg-purple-700">
            Sobre
          </button>
        </div>
      </div>
