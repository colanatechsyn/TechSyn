      ...
      <div className="max-w-7xl mx-auto text-center transform translate-y-[-50px]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          >
            ...
            />
            <h1
              className="text-4xl absolute transform 2xl:translate-y-[-85px] 2xl:translate-x-[100px]"
              data-aos="fade-up"
              data-aos-delay="300"
              data-aos-duration="1000"
            >
            ...
            />
            <h1
              className="text-4xl absolute 2xl:translate-y-[12px]"
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="1000"
            >
          ...
          >
            ...
            />
            <h1
              className="text-4xl absolute 2xl:translate-y-[-85px] 2xl:translate-x-[155px]"
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="1000"
            >
            ...
            />
            <h1
              className="text-4xl absolute 2xl:translate-y-[12px] 2xl:translate-x-[235px]"
              data-aos="fade-up"
              data-aos-delay="200"
              data-aos-duration="1000"
            >
