...
import techsyner from "../../assets/imgs/TechSynersImage/TechSyner.png";
function TopTechSyners() {
  ...
  return (
    <div className="w-[100%] overflow-hidden bg-gradient-to-b from-purple-600 to-blue-500 text-white py-35 px-4 transform bg-fixed relative  z-10 ">
      <img
        src={techsyner}
        alt=""
        className="absolute z-0 filter animate-pulse top-0 w-full"
      ></img>
        ...
        <div className="flex justify-center items-end gap-23 mt-0 mb-11">
          ...
          >
            ...
            <div className="w-55 h-55  rounded-full bg-gradient-to-r from-white to-pink mx-auto mt-2 drop-shadow-2xl">
              ...
              />
              <div className="spinner_animation w-57 h-57 rounded-full bg-gradient-to-r from-white to-pink mx-auto drop-shadow-2xl animate-spin transform translate-x-[-4px] translate-y-[-4px]"></div>
            </div>
